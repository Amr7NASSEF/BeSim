function controller = BeCtrl_1DDD(model_11,model_22,model_33, CtrlParam)
nv=nargin-1;
if nargin == 0
   buildingType = 'Infrax';  
...
for i=1:nv
    eval(['[controller.ARMPC.optimizer' num2str(i) ', controller.ARMPC.constraints_info' num2str(i) ']' '= BeRMPCMINMAXDDD(model_' num2str(i) num2str(i) ', controller.ARMPC);'])
